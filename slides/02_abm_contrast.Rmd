...
As population size grows, as mixing becomes increasingly random, and as individual heterogeneity averages out, the ABM converges in distribution to the ODE. The ODE is what the ABM becomes when both restrictions hold exactly.

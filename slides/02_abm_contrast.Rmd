...
???
Speaker notes: Return to the epigraphs. Block 1 showed what went wrong in both predictions: feedback, ignored. Block 2 shows what feedback looks like when individuals are actually individual — when the population is not a number but a collection of agents, each with a location and a neighborhood.
